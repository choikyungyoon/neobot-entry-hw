...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\Entry_HW.exe"
...
OutFile "NeobotHardwareSetup.exe"
...
Section "MainSection" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\Neobot Hardware\Neobot Hardware.lnk" "$INSTDIR\Entry_HW.exe"
  CreateShortCut "$DESKTOP\Neobot Hardware.lnk" "$INSTDIR\Entry_HW.exe"
